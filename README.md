...
**Upload animation with preview**
Add a new animation to the shared library, including a live preview, so teammates can immediately discover and reuse it.

**Animation preview**
Play a live preview of any animation in the library to visualise motion before committing to an implementation.
